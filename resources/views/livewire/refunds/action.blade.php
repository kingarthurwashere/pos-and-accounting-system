<div>
    <button class="bg-blue-500 text-white py-2 px-4 rounded-lg" wire:click="$toggle('myModal')">{{$label}}</button>
        ...
        <x-mary-card>
            <div class="flow-root">
               ...
               <div class="flex space-x-4">
                <x-mary-button  label="APPROVE" wire:click="action(true)"  class="btn-success text-white flex-grow my-4" />
                <x-mary-button  label="REJECT" wire:click="action(false)"  class="btn-error text-white flex-grow my-4" />
               </div>
              </div>
        </x-mary-card>
