<div class="flex h-6 space-between w-full items-center">
    ...
    <div class="w-full flex justify-end">
        <div class="inline-flex rounded-md shadow-sm" role="group">
            <button onclick='window.location="/pos/payments"' type="button" @class([
                'inline-flex items-center px-4 py-2 text-sm font-medium border-t border-b focus:z-10 focus:ring-2 dark:bg-gray-800 dark:border-gray-700 dark:text-white',
                'bg-white text-gray-900 hover:bg-gray-100 hover:text-blue-700 focus:ring-blue-700 focus:text-blue-700 dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-blue-500 dark:focus:text-white' => !request()->routeIs(
                    'withdrawal-request.index'),
                'text-white dark:bg-gray-900 dark:bg-green-500 border border-green-500 focus:ring-green-500 focus:text-white' => request()->routeIs(
                    'withdrawal-request.index'),
            ])>
                Requests
            </button>
            <button onclick='window.location="/pos/initiate-payment"' type="button" @class([
